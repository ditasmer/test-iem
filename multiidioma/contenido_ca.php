<?php
$titulo1 = 'Institut';
$titulo2 = 'd´Estudis Moderns';
$menu1 = 'L´ESCOLA';
$menu2 = 'CURSOS I HORARIS';
$menu3 = 'SITUACIÓ I CONTACTE';
$titulo_footer='Comparteix a:';
$titulo_contacto = 'LOCALITZACIÓ DEL CENTRE I CONTACTE';
$contacto = 'CONTACTE';
$aviso_campos = 'Els camps marcats amb * son obligatoris.';
$nombre = 'Nom: *';
$email = 'Email: *';
$telefono = 'Teléfon:';
$mensaje = 'Missatge: *';
$textarea = 'Introdueixi aquí la seva pregunta o comentari';
$aceptopolitica = 'He llegit i accepto la política de privacitat:';
$ver= 'Veure aquí';
$enviar = 'Enviar';
